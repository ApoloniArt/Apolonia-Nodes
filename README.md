[README.md](https://github.com/user-attachments/files/26224724/README.md)
# Apolonia Nodes
...
| Node | File | Purpose |
|---|---|---|
| [ApoloniArtiff](#apolloniartiff) | `apoloniartiff_node.py` | Save images in PNG, JPEG, WebP, or TIFF with metadata control |
