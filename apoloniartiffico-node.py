    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "file_type": ([s.FILE_TYPE_PNG, s.FILE_TYPE_JPEG, s.FILE_TYPE_WEBP_LOSSLESS, s.FILE_TYPE_WEBP_LOSSY, s.FILE_TYPE_TIFF, s.FILE_TYPE_ICO], ),
    ...
    def save_images(self, images, filename_prefix="ComfyUI", file_type=FILE_TYPE_PNG, remove_metadata=False, prompt=None, extra_pnginfo=None):
        ...
        for image in images:
            ...
            if extension == "png":
                ...
                # ICO format specific handling
                pass  # No special arguments needed for ICO format
            else:
...
NODE_CLASS_MAPPINGS = {
    "ApoloniArtiffico": ApoloniArtiffico
}
